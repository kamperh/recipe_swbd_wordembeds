...
default_options_dict = {
    ...
    "i_layer_eval": -2,         # -1 corresponds to the softmax layer, -2 to the last hidden layer
    }
...
def main():
    ...
    # Sweep options
    n_hidden_units = None  # if None, this is not swept
    n_hidden_layers = None 
    n_cnn_units = None
    n_hidden_units_final_layer = [300, 512, 1024, 2048, 4096]
    sweep_options_dict = {
        "rnd_seed": range(41, 46)
        }
